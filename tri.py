...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  2 22:28:35 2018
...
class tri: 
    ...
    def Create_Mesh_And_Connectivity_List(self, List_Of_Point, Connectivity):
        ...
        Connectivity.append(["2D", len(List_Of_Point)-3, len(List_Of_Point)-2, len(List_Of_Point)-1])
    ...
    def Create_Tri_and_Normal_Mesh_Connectivity_List(self, List_Of_Point, 
        ...
        List_Of_Point.extend(self.points)
        bary = (self.points[0] + self.points[1] + self.points[2])/3
        List_Of_Point.append(bary)
        List_Of_Point.append(bary + self.normal)
    ...
    def distance_to_a_point(self, P):
        ...
        normal_side  = np.dot(self.normal, P) > np.dot(self.normal,self.points[0]) + 1e-2
